...
<section>
  <div class="page-head"><div><div class="eyebrow">FINANCE · CLOSE THE LOOP</div><h1>财务跟进</h1><p>项目验收并完成结算后，进入开票与回款跟进。开票不能超过合同额，回款不能超过已开票金额。</p></div><Button variant="primary" onclick={() => workspace.open('finance')}><Wallet size={16} />更新开票回款</Button></div>
